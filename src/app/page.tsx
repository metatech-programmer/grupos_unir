...
const features = [
  {
    title: 'Motor de recomendación IA gratuito',
    description: 'La plataforma calcula compatibilidad por zona horaria, disponibilidad diaria, actividades y carga de trabajo.',
    icon: BrainIcon,
  },
  {
    title: 'Coordinación real por horarios',
    description: 'Compara franjas horarias para sugerir equipos con mayor solape de tiempo y menos fricción operativa.',
    icon: ClockIcon,
  },
  {
